...
# class FieldKind(FieldBase, metaclass=_Schematic):
...
# class Field(_ChainChora, FieldBase, metaclass=_Schematic):
...
# # class DegenerateField(_Degenerate, _FullField_, metaclass=_Schematic):
...
# class Sig(_ChainChora, metaclass=_Schematic):
